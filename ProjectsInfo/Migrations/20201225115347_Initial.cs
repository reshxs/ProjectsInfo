        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedHours = table.Column<int>(type: "integer", nullable: false),
                    DevelopmentHourPrice = table.Column<decimal>(type: "numeric", nullable: false),
                    TestingHours = table.Column<int>(type: "integer", nullable: false),
                    TestingHourPrice = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DeveloperAssignmentID = table.Column<int>(type: "integer", nullable: false),
                    DeveloperAssignmentProjectID = table.Column<int>(type: "integer", nullable: false),
                    DeveloperAssignmentDeveloperID = table.Column<int>(type: "integer", nullable: false),
